  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <LinearGradient colors={['#003C43', '#135D66']} style={styles.header}>
       ...
       {/* <TouchableOpacity onPress={()=>navigation.navigate("KROfferList")} style={{justifyContent:"center",width:"80%"}}> */}
      ...
      {loomOrTrader !== 'A' && (
          ...
          </TouchableOpacity>
        {
          ...
          <Animatable.View animation="fadeInUp" delay={1000} style={styles.card}>
            ...
            <Text style={styles.cardText}>Add Looms </Text>
          </Animatable.View>
        </TouchableOpacity> : 
        null
        }
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    paddingHorizontal: 15,  // Added more padding
    elevation: 5,
