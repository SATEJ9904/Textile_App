                    ...
                    <View>
                        <View style={{
                            ...
                            <View style={{ marginLeft: "-30%", marginTop: "5%" }}>
                                <Text style={{ fontSize: 18, color: "#000" }}>Select Role:</Text>
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    />
                                    <Text style={{ fontSize: 18, color: "#fff123456789" }}>Owner</Text>
                                </View>
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    <RadioButton
                                        value="manager"
                        ...
                        <TouchableOpacity style={styles.loginButton} onPress={() => getContact()}>
                            <Text style={styles.loginText}>Submit</Text>
                        </TouchableOpacity>
                    </View> : null}
