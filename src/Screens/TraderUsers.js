...
const TraderUser = ({ navigation }) => {
  ...
  useEffect(() => {
    fetch('https://textileapp.microtechsolutions.co.in/php/getdetail.php')
      ...
      .then((data) => {
        const filteredUsers = data.filter(user => user.LoomOrTrader === 'T');
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.headerTitle}>
          <Text style={styles.headerText}>Trader Users</Text>
        </View>
      </View>
      <TextInput
