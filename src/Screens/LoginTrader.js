...
secureTextEntry
                ...
                <TouchableOpacity style={{ width: "70%", marginTop: "15%", borderRadius: 20, backgroundColor:"#fff",justifyContent: "center", alignItems: "center"}} onPress={()=>NewLogin()}>
                    <Text style={{ color: "#0000A0", fontSize: 25, padding: 7, marginLeft: "3%", fontWeight: "400" }}>Log In</Text>
                </TouchableOpacity>

                <TouchableOpacity style={{ width: "70%", marginTop: "15%", borderRadius: 20, justifyContent: "center", alignItems: "center", borderWidth: 1, borderColor: "#fff" }} onPress={()=>navigation.navigate("SignupTrader")}>
