...
const GetYarnRatesTrader = () => {
  ...
  const renderCard = ({ item }) => (
    <TouchableOpacity
      style={styles.card}
      onPress={() => navigation.navigate('TraderChat', { yarnId: item.Id})}
    >
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('BroadCastTrader', { userType: 'LoomOrTrader' })}
      >
...
export default GetYarnRatesTrader;
