...
const BroadCastTrader = ({ route, navigation }) => {
    ...
    const fetchBroadcastMessages = async () => {
        ...
        fetch('https://textileapp.microtechsolutions.co.in/php/getbyid.php?Table=YarnRate&Colname=TraderId&Colvalue='+await AsyncStorage.getItem("Id"))
            .then(response => response.json())
            .then(data => {
                console.log(userId)
                const filteredMessages = data.filter(msg => !msg.YarnId && !msg.LoomId && msg.TraderId == userId);
    ...
    const sendMessage = async () => {
        ...
        const userId = await AsyncStorage.getItem("Id");
        formdata.append("TraderId", userId);
...
export default BroadCastTrader;
