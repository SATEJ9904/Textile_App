                        ...
                        <View style={{ margin: "10%" }}>
                            ...
                            <View style={styles.detailItem}>
                                ...
                                <CheckBox
                                    ...
                                    value={editedLoom.SelvageJacquard === 1}
                                    onValueChange={(newValue) => handleChange('SelvageJacquard', newValue ? 1 : 0)}
                                />
                            </View>
                            <View style={styles.detailItem}>
                                ...
                                <CheckBox
                                    ...
                                    tintColor="black"
                                    style={styles.checkbox}
                                    value={editedLoom.TopBeam === 1}
                                    onValueChange={(newValue) => handleChange('TopBeam', newValue ? 1 : 0)}
                                />
                            </View>
                            <View style={styles.detailItem}>
                                ...
                                <CheckBox
                                    ...
                                    tintColor="black"
                                    style={styles.checkbox}
                                    value={editedLoom.Cramming === 1}
                                    onValueChange={(newValue) => handleChange('Cramming', newValue ? 1 : 0)}
                                />
                            </View>
                            <View style={styles.detailItem}>
                                ...
                                <CheckBox
                                    ...
                                    tintColor="black"
                                    style={styles.checkbox}
                                    value={editedLoom.LenoDesignEquipment === 1}
                                    onValueChange={(newValue) => handleChange('LenoDesignEquipment', newValue ? 1 : 0)}
                                />
                            </View>
                        </View>
                    </View>
